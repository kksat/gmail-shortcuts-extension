/**
 * Gmail Snooze Shortcuts
 * Fast, lightweight hotkeys for snoozing emails in Gmail.
 *
 * Shortcuts:
...
(function () {
  ...
  if (window.__gmail_snooze_installed) return;
  window.__gmail_snooze_installed = true;
  ...
  /**
   * Display a non-intrusive HUD at the bottom of the screen.
   */
